...
import { PercentageOptionModel } from './percentageOptionModel';


export interface TargetingRuleModel { 
    /**
     * The user conditions that are combined with the AND logical operator.  It can be one of the following:  - User condition  - Segment condition  - Prerequisite flag condition
     */
