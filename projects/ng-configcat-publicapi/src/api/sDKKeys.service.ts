...
export class SDKKeysService {
    ...
    public getSdkKeys(configId: string, environmentId: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json' | 'application/hal+json'}): Observable<any> {
        ...
        return this.httpClient.get<SdkKeysModel>(`${this.configuration.basePath}/v1/configs/${encodeURIComponent(String(configId))}/environments/${encodeURIComponent(String(environmentId))}`,
            {
